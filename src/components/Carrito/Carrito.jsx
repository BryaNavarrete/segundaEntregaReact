  ...
  if (carrito.length === 0) {
    return (
      <div className="cart-empty" >
        ...
        <Link to="/" style={{color: "red", textDecoration: "none"}}>Ver productos</Link>
      </div>
    );
  }
    ...
    <div className="cart">
      ...
      {carrito.map((productoCarrito) => (
        <div className="card-cart" key={productoCarrito.id}>
          ...
          <IoTrash size={40} color="red" onClick={() => borrarProductoPorId(productoCarrito.id)} style={{ cursor: 'pointer' }}/>
